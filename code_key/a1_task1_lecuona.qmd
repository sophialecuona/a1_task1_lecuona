...
# Amphibian Abundance Sierra Lakes Inventory Project: Non-Native fish and community composition of lakes and ponds in the Sierra Nevada, California
...
## First, we want to see the total mountain yellow-legged frog (Rana muscosa) count each year across all water bodies, by life stage excluding the ‘EggMass’ level.
...
```{r}
#| fig-cap: "Panel A (above):  Number of total mountain yellow-legged frog (*Rana muscosa*) each year across all water bodies, by life stage.  Panel B (below): Counts of combined adult and subadult endangered mountain yellow-legged frogs (*Rana muscosa*) observed in the 5 lakes with the greatest total observed counts."
